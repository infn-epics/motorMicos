...
dbLoadRecords("/epics/support/motor/db/asyn_motor.db","P=$(P),M=:HMOT01,DTYP=asynMotor,PORT=pollux1,ADDR=0,DIR=Pos,DESC=M0,EGU=degrees,VMAX=5.,VELO=3.,VBAS=.5,ACCL=.5,BDST=0,BVEL=1.0,BACC=2,MRES=001,PREC=2,DHLM=12,DLLM=0,INIT=")
dbLoadRecords("/epics/support/motor/db/asyn_motor.db","P=$(P),M=:VMOT01,DTYP=asynMotor,PORT=pollux1,ADDR=1,DIR=Pos,DESC=M1,EGU=degrees,VMAX=5.,VELO=3.,VBAS=.5,ACCL=.5,BDST=0,BVEL=1.0,BACC=2,MRES=001,PREC=2,DHLM=12,DLLM=0,INIT=")
